...
import timm
from models.resnet import resnet50_lora, resnet101_lora, resnet152_lora
...
class ModelRes_Lora(nn.Module):
    def __init__(self, res_base_model, r=16, lora_alpha=16):
        super(ModelRes_Lora, self).__init__()
        self.r = r
        self.lora_alpha = lora_alpha
        self.resnet_dict = {
                            # "lora_resnet50": [resnet50_lora, 'ResNet50_Weights.IMAGENET1K_V2'],
                            # "lora_resnet101": [resnet101_lora, 'ResNet101_Weights.IMAGENET1K_V2'],
                            "lora_resnet152": [resnet152_lora, 'ResNet152_Weights.IMAGENET1K_V2'],
                            }
